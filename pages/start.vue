    ...
    <div class="main">
        <div class="canvas">
            <div class="grid h-screen w-full bg-[#121212]">
                <div class="mt-[15vw] lg:mt-[3vw] mx-auto lg:w-[65rem] min-[1450px]:w-[90rem] flex-grow grid lg:grid-cols-3 min-[1450px]:grid-cols-4 place-content-center gap-8">
                    <!-- astronaut section -->
                    <div class="col-span-1 h-full items-center justify-center hidden min-[1450px]:flex">
                    ...
                    <div class="flex flex-col col-span-2 gap-8 h-full">
                        ...
                        <div class="flex flex-col gap-4 border-2 border-indigo-500 rounded-xl p-8 h-min"
                            ...
                            >
                                <button class="btn rounded-full" @click="selectTag">Landing Page</button>
                            </div>
                            <div
                                class="tooltip tooltip-accent tooltip-bottom font-bold"
                                data-tip="Every backend/frontend program you need."
                            >
                                <button class="btn rounded-full" @click="selectTag">Internal Software</button>
                            </div>
                            <div
                                class="tooltip tooltip-accent tooltip-bottom font-bold"
                                data-tip="Fast and efficient online store in any style you want."
                            >
                                <button class="btn rounded-full" @click="selectTag">Online Store</button>
                            </div>
                            <div
                                class="tooltip tooltip-accent tooltip-bottom font-bold"
                                data-tip="An admin panel for all your management purposes."
                            >
                                <button class="btn rounded-full" @click="selectTag">Management Page</button>
                            </div>
                            <div
                                class="tooltip tooltip-accent tooltip-bottom font-bold"
                                data-tip="From user authentication/login to managing tiered users."
                            >
                                <button class="btn rounded-full" @click="selectTag">User Accounts</button>
                            </div>
                            <div
                                class="tooltip tooltip-accent tooltip-bottom font-bold"
                                data-tip="A form for collecting client information."
                            >
                                <button class="btn rounded-full" @click="selectTag">Intake Page</button>
                            </div>
                            <div
                                class="tooltip tooltip-accent tooltip-bottom font-bold"
                    ...
                    <div class="flex flex-col col-span-2 lg:col-span-1 gap-8">
                        ...
                        <div class="flex flex-col gap-4 border-2 border-purple-500 rounded-xl p-8 flex-grow justify-center">
                            ...
                            <div class="mx-auto form-control w-full lg:max-w-xs">
                                <select class="select select-bordered rounded-lg" v-model="user_input.who_are_you" @click="changeAstronaut(3)">
                                    <option value="default" disabled selected>Who are you?</option>
