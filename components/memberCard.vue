...
export default {
    ...
    data() {
        return { 
            images: ["../assets/member_logos/finn_logo.png", "../assets/member_logos/jinny_logo.png", "../assets/member_logos/robby_logo.png", "../assets/member_logos/daniel_logo.png"],
    ...
    methods: {
        ...
        card1Rotate1(){
                ...
                const card1ImgChange = [
                    ...
                    {width: "100%", content: "url('../assets/member_photos/finn_photo.png')", offset: 0.5},
                    {width: "100%", content: "url('../assets/member_photos/finn_photo.png')"},
                ];
                ...
                setTimeout(() => {
                    ...
                    card1Img.style.content = "url('../assets/member_photos/finn_photo.png')";
                }, 500)
        ...
        card1Rotate2(){
                ...
                const card1ImgChange = [
                    ...
                    {width: "80%", content: "url('../assets/member_logos/finn_logo.png')", offset: 0.5},
                    {width: "80%", content: "url('../assets/member_logos/finn_logo.png')"}
                ];
                ...
                setTimeout(() => {
                    ...
                    card1Img.style.content = "url('../assets/member_logos/finn_logo.png')";
                }, 500)
                card1Img.animate(card1ImgChange, card1ImgChangeOptions);
        ...
        card2Rotate1(){
                ...
                const card2ImgChange = [
                    {},
                    {content: "url('../assets/member_photos/jinny_photo.png')"},
                    {content: "url('../assets/member_photos/jinny_photo.png')"},
                ];
                ...
                setTimeout(() => {
                    card2Img.style.content = "url('../assets/member_photos/jinny_photo.png')";
                }, 500)
        ...
        card2Rotate2(){
                ...
                const card2ImgChange = [
                    {},
                    {content: "url('../assets/member_logos/jinny_logo.png')"},
                    {content: "url('../assets/member_logos/jinny_logo.png')"},
                ];
                ...
                const card2Img = document.querySelector("#card2 img");
                setTimeout(() => {
                    card2Img.style.content = "url('../assets/member_logos/jinny_logo.png')";
                }, 500)
                card2Img.animate(card2ImgChange, card2ImgChangeOptions);
        ...
        card3Rotate1(){
                ...
                const card3ImgChange = [
                    {},
                    {content: "url('../assets/member_photos/robby_photo.png')"},
                    {content: "url('../assets/member_photos/robby_photo.png')"},
                ];
                ...
                setTimeout(() => {
                    card3Img.style.content = "url('../assets/member_photos/robby_photo.png')";
                }, 500)
        ...
        card3Rotate2(){
                ...
                const card3ImgChange = [
                    {},
                    {content: "url('../assets/member_logos/robby_logo.png')"},
                    {content: "url('../assets/member_logos/robby_logo.png')"},
                ];
                ...
                const card3Img = document.querySelector("#card3 img");
                setTimeout(() => {
                    card3Img.style.content = "url('../assets/member_logos/robby_logo.png')";
                }, 500)
                card3Img.animate(card3ImgChange, card3ImgChangeOptions);
        ...
        card4Rotate1(){
                ...
                const card4ImgChange = [
                    ...
                    {width: "80%", offset: 0.25},
                    {width: "100%", offset: 0.251},
                    {width: "100%", content: "url('../assets/member_photos/daniel_photo.png')", offset: 0.5},
                    {width: "100%", content: "url('../assets/member_photos/daniel_photo.png')"},
                ];
                ...
                setTimeout(() => {
                    ...
                    card4Img.style.content = "url('../assets/member_photos/daniel_photo.png')";
                }, 500)
        ...
        card4Rotate2(){
                ...
                const card4ImgChange = [
                    ...
                    {width: "100%", offset: 0.25},
                    {width: "80%", offset: 0.251},
                    {width: "80%", content: "url('../assets/member_logos/daniel_logo.png')", offset: 0.5},
                    {width: "80%", content: "url('../assets/member_logos/daniel_logo.png')"}
                ];
                ...
                setTimeout(() => {
                    ...
                    card4Img.style.content = "url('../assets/member_logos/daniel_logo.png')";
                }, 500)
                card4Img.animate(card4ImgChange, card4ImgChangeOptions);
