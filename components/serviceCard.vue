...
export default {
  ...
  methods: {
    ...
    changeInnerText(text, serviceNum) {
      document.querySelector(`#service${serviceNum} .description`).innerHTML =
        text;
    },
    ...
    minimizeService(serviceNum) {
      document.querySelector(`#service${serviceNum} .tags`).style.display =
        "none";
      document.querySelector(`#service${serviceNum} .tags`).style.opacity = "0";
      document.querySelector(
        `#service${serviceNum} .description`
      ).style.display = "none";
      document.querySelector(
        `#service${serviceNum} .description`
      ).style.opacity = "0";
      document.querySelector(
        `#service${serviceNum} .learn_more`
      ).style.display = "none";
      document.querySelector(
        `#service${serviceNum} .learn_more`
      ).style.opacity = "0";
      document.querySelector(`#service${serviceNum} .title`).style.transform =
        "rotate(90deg) translateX(5vw)";
    },
    ...
    learnMore() {
      if (this.title === "Business Solutions") {
        ...
        this.changeInnerText(this.detailed_descriptions[2], 3);
        document.querySelector("#service3 .main_content").style.height =
          "100vw";
      }
    },
  },
